...
const ServiceSentence = () => {
  ...
  const services = [
    {
      ...
      description:
        "Automated farm documentation with standardized templates that ensure accuracy and compliance with agricultural best practices.",
      features: [
        "Sales Tracking",
        "Expense Management",
        "Inventory Records",
    ...
    },
    {
      ...
      description:
        "Advanced artificial intelligence that provides real-time insights and recommendations for optimal farm management decisions.",
      features: [
        "Disease Detection",
        "Yield Prediction",
        "Market Analysis",
    ...
    },
    {
      ...
      description:
        "Seamlessly share farm performance data with investors, partners, or managers through secure, real-time dashboard links.",
      features: [
        "Live Sharing",
        "Access Control",
        "Export Options",
  ...
  return (
    <div
      className="relative w-full border-t border-t-sky-100/30 py-16 bg-[#0a1905]"
      id="Services"
    >
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Empowering farmers with cutting-edge digital tools that
                transform traditional farming into{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {services.map((service, index) => (
              ...
              >
                {/* Service Icon */}
                <div
                  className={`w-16 h-16 rounded-2xl bg-linear-to-r ${service.color} flex items-center justify-center text-2xl mb-6 shadow-lg`}
                >
                  {service.icon}
                </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                to="/Account"
                className="bg-white text-[#009966] hover:bg-gray-100 font-bold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-2xl"
              >
                SignUp Now
              </Link>
            </div>
