...
if (error) {
return ( <div className="max-w-lg mx-auto p-5 text-center"> <h1 className="text-2xl font-bold text-red-600 mb-4">Link Error</h1> <p className="text-gray-700">{error}</p> </div>
);
}

if (!data) {
return ( <div className="max-w-lg mx-auto p-5 text-center"> <p className="text-gray-600">Loading shared dashboard...</p> </div>
);
}

const { sales, summary, settings } = data;
...
return ( <div className="max-w-4xl mx-auto p-5 space-y-6"> <h1 className="text-2xl font-bold text-gray-800 text-center">
Shared Sales Dashboard </h1>
