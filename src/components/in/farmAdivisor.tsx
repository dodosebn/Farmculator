  ...
  return (
    ...
    <div className="flex h-screen bg-linear-to-br from-gray-50 to-green-50/30 overflow-hidden">
      ...
      >
        {!isSidebarOpen && (
          <div className="border-b border-gray-200 bg-white/80 backdrop-blur-sm p-4 shadow-sm">
            <button
              ...
              className="p-2.5 hover:bg-green-50 rounded-xl transition-all duration-200 text-green-700 hover:text-green-800 border border-transparent hover:border-green-200"
            >
              <FiSidebar size={20} />
            </button>
          </div>
        ...
        >
          <div
            className={`w-full mx-auto px-4 sm:px-6 py-6 min-h-full ${isSidebarOpen ? "max-w-4xl" : "max-w-6xl"}`}
          >
            {/* Empty State */}
            {messages.length === 0 && (
                ...
                >
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full px-6 py-4 pr-16 border border-gray-300 
                      rounded-sm resize-none focus:outline-none focus:ring-1
                       focus:ring-green-500/20 focus:border-green-200
                        text-gray-900 placeholder-gray-400 shadow-sm bg-white/80 backdrop-blur-sm transition-all duration-200 text-lg leading-6"
                      rows={3}
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className={`text-sm leading-7
                           ${msg.role === "user" ? "text-green-50" : "text-gray-700"}`}
                      >
                        {msg.isGenerating ? (
                          <div className="flex items-center gap-2">
                            <span className="flex gap-1">
                              <span
                                className="inline-block w-2 h-2 bg-green-400 
                            ...
                            <span className="text-green-600">Thinking...</span>
                          </div>
                        ) : (
                    ...
                    {msg.role === "user" && (
                      <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-br
                       from-gray-600 to-gray-700 rounded-full flex items-center
                        justify-center shadow-md mt-1">
                        <div className="flex items-center gap-3 p-3 rounded-xl
                         cursor-pointer">
                          <div className="w-3 h-3 rounded-xl flex items-center 
        ...
        {messages.length > 0 && (
          <div className="border-t border-gray-200/60 bg-white/80 backdrop-blur-sm shadow-lg">
            <div
              className={`mx-auto px-4 sm:px-6 py-5 ${isSidebarOpen ? "max-w-4xl" : "max-w-6xl"}`}
            >
              <form onSubmit={handleSubmit} className="relative">
                <div className="relative">
                  <textarea
                    ...
                    placeholder="Ask about crops, livestock, soil, weather, or any farming topic..."
                    className="w-full px-5 py-4 pr-16 border border-gray-300 rounded-2xl resize-none focus:outline-none focus:ring-3 focus:ring-green-500/20 focus:border-green-500 text-gray-900 placeholder-gray-400 bg-white shadow-sm transition-all duration-200 text-lg leading-6"
                    disabled={isGenerating}
