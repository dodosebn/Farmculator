...
const shareViaEmail = () => {
const subject = "Sales Dashboard Share";
const body = `Check out my sales dashboard: ${shareLink}`;
window.open(`mailto:?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`);
};

const shareViaWhatsApp = () => {
const text = `Check out my sales dashboard: ${shareLink}`;
...
return ( <div className="max-w-6xl mx-auto p-4 sm:p-6"> <ShareLink
